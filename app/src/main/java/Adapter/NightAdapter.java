...
public class NightAdapter extends RecyclerView.Adapter<NightAdapter.MyViewHolder> {
    ...
    private DayAdapter.RecyItemOnclick recyitemonclick;

    public void setRecyItemOnclick(DayAdapter.RecyItemOnclick Listener){
        this.recyitemonclick=Listener;
    }

    public NightAdapter(Context mContext , DailyWeatherData mDailyWeatherData) {
    ...
    @Override
    public void onBindViewHolder(final NightAdapter.MyViewHolder holder, int position) {
/**获取时间数据
 * @hour 小时
 ...
 * */
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView tv_tianqi;
        TextView tv_wendu;
        DayAdapter.RecyItemOnclick recyItemOnclick;
        public MyViewHolder(View itemView, DayAdapter.RecyItemOnclick recyItemOnclick) {
            super(itemView);
